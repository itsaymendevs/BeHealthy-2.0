...
class PlansCheckoutPrivacy extends Component
{
    public function render()
    {
        ...
        return view('livewire.website.plans.plans-checkout.components.plans-checkout-privacy', compact('settings', 'header', 'titles', 'content'));
