    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                {{-- title --}}
                <h1 class="text-center insta--title fw-800 fs-xxl-32 fs-xl-32 fs-lg-30 fs-md-30 fs-sm-22">
                ...
                <p class="text-center insta--subtitle fs-lg-16 fs-md-15 fs-sm-16">
                    See how we’re making every day extraordinary — one post at a
                    time.
                </p>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-start align-items-center insta--post-wrapper">
            ...
            <div data-aos="fade-up" data-aos-duration="600" data-aos-delay="200" class="insta--post" wire:ignore.self>
                ...
                <div class="insta--post-content">
                    <a class="btn" role="button" href="#"><img src="{{('assets/img/helpers/insta-3.png')}}" /></a>
                </div>
            </div>
            ...
            <div data-aos="fade-up" data-aos-duration="600" data-aos-delay="300" class="insta--post d-none d-xl-flex"
                ...
                <div class="insta--post-content">
                    <a class="btn stretched-link" role="button" href="#"><img
                            src="{{('assets/img/helpers/insta-3.png')}}" /></a>
                </div>
            </div>
