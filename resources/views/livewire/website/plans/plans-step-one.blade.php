            ...
            <div class="col-lg-7 offset-lg-5 col-md-6 col-12">
               <div class='d-block'>
                  <div class="step">
                     ...
                     {{-- heading - shared --}}
                     <p class="step-heading" type="button" data-bs-toggle="collapse" data-bs-target="#choosePrefrence"
                        aria-expanded="true" aria-controls="choosePrefrence" wire:ignore>
                        <span>
                           Step 1
                        ...
                        <div class="col-6 col-sm-4 col-md-6 col-xl-4 mb-3 h-100"
                           ...
                           <label class="check-box action bundle-options w-100 h-100">
                              ...
                              <input type="radio" name="bundleRange" value="{{ $bundleRange->range->id }}"
                                 wire:model='instance.bundleRangeId' class='d-none' wire:change='changeBundleRange'>
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                           <div class="check-box action">
                              <label>
                                 <input type="radio" name="nutrationist" value="1" onclick="toggleMeetingOptions(this)">
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                           <div class="check-box action">
                              <label>
                                 <input type="radio" name="nutrationist" value="2" onclick="toggleMeetingOptions(this)">
                                 <div class="check-item">
                                    <div>
                                       <p class="title">No</p>
                                    </div>
                        ...
                        <div class="col-12 col-lg-6" wire:ignore>
                           <div class="input-group mb-4 w-100 focus">
                              <input required="" type="text" name="text" autocomplete="off"
                                 class="input date-input w-100 " id="datepicker" wire:model='instance.startDate'
                                 min='{{ $globalTodayDate }}'>
