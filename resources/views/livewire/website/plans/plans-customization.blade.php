...
<div class="wrapper">
         ...
         <div class="row">
            ...
            <div class="col-12 col-lg-8">
               ...
               <div class="row justify-content-center justify-content-sm-start" wire:ignore>
                  ...
                  <div class="col-12 col-sm-12 col-lg-6 mb-4 text-center">
                     ...
                     <div class='d-flex justify-content-end mt-4 px-1 px-sm-0'>
                        <a href="{{ route('website.plans.details', [$plan->nameURL]) }}" class='btn--with-hr active'>
                           <hr>
                     ...
                     <div class="collapse show mt-4" id="collapse--bundles" wire:ignore.self>
                        ...
                        <div class="row justify-content-center justify-content-md-start mx-0">
                           ...
                           <div class="col-4 col-sm-4 col-lg-4 col-xl-3 mb-4 scrolla-element-anim-1 scroll-animate px-1"
                              ...
                              <label wire:loading.class='processing--card' wire:target='changePlanBundle' class="bundle--card sm zoom--wrapper motion--slow pointer
                                 ...
                                 <input type="radio" id="bundle--checkbox-{{ $bundle->id }}"
                                    ...
                                    name='bundle--checkbox' value='{{ $bundle->id }}' wire:change='changePlanBundle'>
                        ...
                        <div class="row mt-4 justify-content-center justify-content-md-start">
                           <div class="col-12 col-sm-12">
                              ...
                              {{-- groupButtons --}}
                              <div class="btn-group mx-auto ranges--wrapper" data-animate="active" role="group">
                                 ...
                                 <button type="button" wire:loading.class='processing--button'
                                    wire:target='changePlanBundleRange' key='single-bundle-range-{{ $bundleRange->id }}'
                        ...
                        <div class="row mt-4 justify-content-center justify-content-sm-start">
                           ...
                           <div class="col-12 col-sm-7 mb-5">
                              ...
                              <div class="d-inline-flex flex-wrap plan--days-wrapper">
                                 ...
                                 <label class='pointer plan--days motion--slow
                                    ...
                                    key='plan-bundle-days-{{ $bundleDay->id }}' wire:loading.class='processing--button'
                                 ...
                                 {{-- radioButton --}}
                                 <input type="radio" id="bundle--days-radio-{{ $bundleDay->id }}" class='d-none'
                                    wire:model.live='instance.planDays' wire:change='recalculate'
                                    name='bundle--days-radio' value='{{ $bundleDay?->days }}'>
                           ...
                           <div class="col-12 col-sm-5 mb-5">
                              ...
                              <div class="d-flex form--input-wrapper">
                                 <input id='date--picker' type="text" name="text" class='form--input form--datepicker'
                                    autocomplete="off">
                              </div>
               ...
               <div class="row  justify-content-center justify-content-md-start section--colorful animation--floating"
                  ...
                  {{-- collapseContent --}}
                  <div class="col-12 col-sm-12">
                     <div class="collapse show mt-4 pt-2 preference--line" id="collapse--preferences" wire:ignore.self>
                        ...
                        <div class="row align-items-end">
                           ...
                           <div class="col-12
                              ...
                              <div class="d-flex form--input-wrapper flex-column mb-4">
                                 ...
                                 <div class="form--select-wrapper" wire:ignore>
                                    <select class='init--select form--select' data-instance='instance.allergyLists'
                                       multiple>
                              ...
                              <div class="d-flex form--input-wrapper flex-column">
                                 ...
                                 {{-- select --}}
                                 <div class="form--select-wrapper" wire:ignore>
                                    <select class='init--select form--select' data-instance='instance.excludeLists'
                                       multiple>
                           ...
                           <div class="@if ($instance->isExistingCustomer) col-12 @else col-12 col-md-6 @endif">
                              ...
                              <div class="d-flex position-relative bag--wrapper mt-5 mt-md-0 mb-4 mb-md-0">
                                 ...
                                 {{-- info --}}
                                 <a href="javascript:void(0);" class='bag--info ' data-izimodal-open="#bag--modal"
                                 ...
                                 <img src='{{ url("{$storagePath}/bags/{$bag->imageFile}") }}' class='w-100 of-contain'
                                    style="height: 200px">
                                 ...
                                 <div class="form-check form-switch bag--switch vertical">
                                    <input class="form-check-input @if(!$hasOptionalBag) no-events @endif"
                                       wire:change='recalculate' type="checkbox" role="switch" id="coolbag--checkbox"
                                       wire:model.live='instance.bag' @if(!$hasOptionalBag) required @endif>
                                    <label class="form-check-label @if(!$hasOptionalBag) no-events @endif"
                                       for="coolbag--checkbox">{{ $bag->name }}</label>
                                 </div>
                              </div>
                           ...
                           <div class="col-12 col-md-5">
                              ...
                              <div class="d-flex position-relative bag--wrapper without--picture">
                                 ...
                                 <div class="form-check form-switch bag--switch vertical">
                                    ...
                                    <input class="form-check-input @if(!$hasOptionalBag) no-events @endif"
                                       type="checkbox" role="switch" wire:change='recalculate' id="coolbag--checkbox"
                                       wire:model.live='instance.bag' wire:change='rec' @if(!$hasOptionalBag) required
                                       @endif>
                                    <label class="form-check-label @if(!$hasOptionalBag) no-events @endif"
                                       for="coolbag--checkbox">{{ $bag->name }}</label>
                                 </div>
                           ...
                           <div class="@if ($instance->isExistingCustomer) col-12 @else col-12 col-md-7 @endif">
                              <form class="d-flex form--input-wrapper justify-content-center mt-3
                                 ...
                                 <livewire:website.components.items.button-blob title='Proceed' type="submit" />
            ...
            <div class="col-12 col-lg-4 mt-5 mt-lg-0 preference--col">
               ...
               <div class="d-flex flex-column-reverse flex-lg-column">
                  ...
                  <div class="d-flex flex-column mb-5">
                     ...
                     {{-- collapseToggler --}}
                     <div class="section section-inner started-heading mb-4 mt-0" style="z-index: 1000" wire:ignore>
                        <div class="container">
                           <div class="row">
                                 ...
                                 <div class="h-titles">
                                    ...
                                    <div class="m-title plan--single-title fs-5 mb-0 fw-semibold  pointer">
                                       <div
                                          ...
                                          {{-- collapseToggler --}}
                                          <div
                                             class="splitting-text-anim-1 scroll-animate collapse--title motion--slow w-100 plans--other-toggler no-events"
                                             data-splitting="chars" data-animate="active" data-bs-toggle="collapse"
                                             data-bs-target="#collapse--other-plans" aria-expanded="false"
                                             aria-controls="collapse--other-plans" data-splitting="chars">
                                             <div class="d-flex justify-content-between">
                                                <span>Plans</span>
                                                <i class="bi bi-chevron-compact-down collapse--icon"></i>
                                             </div>
                        ...
                        <div class="section section-inner m-works mb-5">
                           <div class="container">
                              <div
                                 ...
                                 <div
                                    class="works-col mx-auto plans--other-col col-12 col-sm-6 col-md-6 col-lg-12 col-xl-6 sorting-photography "
                                    key='single-other-plan-{{ $key }}'>
                                    <div
                                       class="works-item other--item @if (($key + 1) % 2 == 0) active @endif scrolla-element-anim-1 scroll-animate"
                                       data-animate="active">
                                       <a href="{{ route('website.plans.customization', [$singlePlan->nameURL]) }}">
                  ...
                  <div class="d-flex flex-column mb-5">
                     ...
                     {{-- collapseToggler --}}
                     <div class="section section-inner started-heading mt-0 mb-4" style="z-index: 1000;" wire:ignore>
                        <div class="container">
                           <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                 <div class="h-titles">
                                    <div class="m-title plan--single-title fs-5 mb-0 fw-semibold  pointer">
                                       <div
                                          ...
                                          {{-- collapseToggler --}}
                                          <div
                                             class="splitting-text-anim-1 scroll-animate collapse--title motion--slow w-100"
                                             data-splitting="chars" data-animate="active" data-bs-toggle="collapse"
                                             data-bs-target="#collapse--bundle-information" aria-expanded="false"
                                             aria-controls="collapse--bundle-information" data-splitting="chars">
                                             <div class="d-flex justify-content-between">
                        ...
                        <div class="section section-inner m-works mb-0">
                           <div class="container">
                              ...
                              <div class="row zoom--wrapper align-items-end">
                                 ...
                                 <div class="col-12 mb-3 mb-md-0 mb-lg-3 mb-xl-0 col-md-6 col-lg-12 col-xl-6">
                                    <div class="d-flex overflow-hidden">
                                       <img
                                          src='{{ url("{$storagePath}/menu/plans/bundles/{$pickedPlanBundle?->imageFile}") }}'
   ...
   {{-- information --}}
   <livewire:website.plans.plans-customization.components.plans-customization-information name='{{ $plan->nameURL }}' />
